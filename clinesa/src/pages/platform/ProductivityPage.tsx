  ...
  const features = [
    {
      ...
      description: "Colabora eficientemente con tu equipo médico en tiempo real.",
      details: [
    ...
    },
    {
      ...
      description: "Mantén toda la comunicación médica en un solo lugar.",
      details: [
    ...
    },
    {
      ...
      description: "Coordina horarios y recursos entre todo el equipo.",
      details: [
        "Calendarios compartidos",
        "Gestión de turnos",
        "Reservas de consultorios",
    ...
    },
    {
      ...
      description: "Accede y edita documentos médicos de forma colaborativa.",
      details: [
        "Edición simultánea",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl font-light">
                Herramientas de colaboración diseñadas específicamente para equipos médicos. 
                Mejora la comunicación y coordinación en tu clínica.
              </p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light">
              Descubre cómo nuestras herramientas de colaboración mejoran la productividad de tu equipo.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
              ¿Listo para mejorar la colaboración?
            </h2>
            <p className="text-xl text-gray-300 mb-8 font-light">
              Descubre cómo nuestras herramientas de colaboración pueden transformar tu equipo médico.
            </p>
